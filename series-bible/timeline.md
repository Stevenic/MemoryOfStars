...
The single source of truth for **when** things happen. Every book's synopsis should
...
| Era | Span (CR) | Summary |
|-----|-----------|---------|
| Deep time | ≲ −1,000,000 | The Choir rise and end; the Witness begins its vigil; the oldest structures (the vault, and whatever cut the circle-crossed-line into it) already old. ⚑ Pending Book 05 sign-off. |
...
| When (CR) | Event | Books | Notes |
|-----------|-------|-------|-------|
| ~−1,000,000 | The Choir end; the Witness takes up its duty | 05 | Cause of their ending: never explained. |
| ~−252 | The *Anthem* is lost | 03 | 312 years before Book 03 — predates Book 01's events. |
| ~−120 | The Bridge Night in Meret | 04 | Three centuries of Relivings by the Mercy (Book 04). |
| −53 → 0 | Elias's annual climbs to the Gate | 01 | Fifty-three years of the same question. |
| **0** | **The Pilgrimage of Lyra Ash** | 01 | The anchor event. |
...
| ~240 | The unroaded system is found; the first carrier | 05 | ⚑ canon event (humanity not the first) pending sign-off. |
...
_Where each novella sits on the timeline (they need not be in chronological order)._

| Book | CR (proposed) | Duration | Where (see [atlas](atlas.md)) |
|------|--------------:|----------|-------------------------------|
| 01 | 0 (prologue −, epilogue +) | ~2 weeks | The Orin system |
| 02 | ~25 | ~1 season | The Orin system (Orin → Valen) |
| 03 | ~60 (epilogue years later) | ~1 season + coda | The Skerry's post |
| 04 | ~180 | ~1 year | Meret's system |
| 05 | ~240 | ~months | The unroaded system |
| 06 | ~300 | ~1 season | The guild chapter-house → Farrow |
| 07 | ~300 (prologue ~200) | ~weeks | Sowen |
| 08 | ~301 (epilogue years later) | ~1 season | The Librarian's site |
| 09 | ~312 | ~60 days | The war's reach (Corvane–Dresk frontier; the Selt system) |
