# The Last Archive — Outline

**Memory of Stars — Novella #27** · **Target length:** ~28,500 words · **Structure:**
Prologue + **8 chapters (2 acts × 4)** + Epilogue — chosen: a siege book in the
held-breath shape — two movements (the stand; the carriage), one Listener, and the
oldest room the series ever lit.

- **Facet:** memory as **sacrifice**.
- **Central question:** *What does the keeper owe the kept, at the end?*
- **The book's job:** the stand. The erratic collection's path crosses the series'
  most sacred holding: **the vault of the Choir** — the Witness, banked since Book
  5, keeping a dead species for carriers to come. Coherent, ancient, vast: under
...
- **The stand:** not a defense (nothing defends against the collector; the whole
  series established it) — a **race**: disperse the vault's remaining strata into
  living carriers before the collection arrives. Every carrier the practice ever
  trained converges (← Book 5's precedent; ← Book 29's POV among them); the
...
- **Chapter-Two Rule:** chapter 2 is the vault waking — the Witness, banked for
  two and a half centuries, speaking first: *"They are coming for my charges. I
...
- **The Witness** — banked, waking, ending. Courteous as ever; the series' first
  great keeper, given its finish.
- **Chancellor Bode** — at the vault in person: his best book. The Regency's
  case argued over a real clock by a man who means it; his defeat here is
  arithmetic, not rhetoric — and he *helps* in the last hours, which is the
  series' kind of opponent.
- **Gale** — routes the carriage's outbound legs: the courier's craft at
  fleet scale.
...
- [ ] New truth — the great carriage is possible at fleet scale; the Witness's
      bait-choice works once and cannot be repeated; even keepers end. *(Ch 3, 7.)*
...
- [ ] Civilization changed — the carried Choir walks the reach in hundreds of
      minds; the Regency bends for the first time (Bode helped); the relief has
      its reason. *(Ch 7–8.)*
- [ ] Larger universe — the collector took the largest single thing it has ever
      taken; what that does to a failing keeper is Book 28's opening weather.
      *(Ch 7 → 28.)*

## Laws & mystery discipline
- **No cheap resurrection:** the Witness is gone — no echo, no return, no
  fragment cutely surviving; the uncarried Choir is lost except as description.
  The sacrifice buys hours, not exemption.
- **Bookend discipline (← Book 5):** the vault, the threshold, the counting, the
  arithmetic, the one-who-stayed — every echo is Book 5's own furniture; no new
  mythology enters the room. Cassen's dissent quoted once, exactly.
- **Counterparty discipline:** Bode loses on arithmetic, helps from decency, and
  *does not convert* — the Regency's case survives the vault (he will argue it
  again at the threshold, → 29–30, with this grief in his voice).
- **Canon-spend guard:** zero. Where the taken go stays kept; the Custodian
  appears only as the collection's behavior; the door is referred, not shown.
...
- **Echoes carried:** Book 5 entire, as ground and grammar; the carriage rite
  (← Books 3/5), at fleet scale; the watch-roll's carrier column; "most will
  never be carried" (← Book 5's dissent, honored); the dossier tradition's last
  deposition (← C3).
- **Hooks outward:** the referral (the door = the dead address — ← Books 11/15's
  accepted shipment and returned crate — → 29's threshold); the collector,
  gorged on the largest taking ever (→ 28's erratic surge); Zel's three-species
  dreams (→ 29); Bode's grief-argument (→ 29–30).
- **New names** (→ glossary via `canonize` when drafted): the great carriage,
  the warding (Regency sense), the deposition's last line (unwritten, spoken).

## Continuity checklist
- [ ] Placed on the [master timeline](../../../series-bible/timeline.md) (~CR 490).
- [ ] New characters/locations → [bible](../../../series-bible/) (the great carriage; the vault's end).
- [ ] New terms → [glossary](../../../series-bible/glossary.md) (great carriage, warding).
- [ ] No [intentionally-undefined question](../../../series-bible/seven-laws.md#things-that-are-intentionally-undefined) answered — the Witness's end is chosen, not explained; where the taken go stays kept.
