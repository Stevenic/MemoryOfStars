...
- **Voice is non-negotiable** — flowing paragraphs with the single-line drop saved for the beats that earn it; dialogue beats attached (never more than ~3 clipped exchanges without a body) with each character deflecting differently; **emotion carried by the body, never named** (no banned templates — voice.md §6); the uncanny stated flatly with dread built by repetition/counting; land the chapter on a short resonant line. Run `voice.md`'s 30-second self-check on your own draft.
